...
public class MaterialDialog extends DialogBase
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                this.widgetColor = ThemeUtils.resolveColor(context, androidx.appcompat.R.attr.colorAccent, this.widgetColor);
            }
            ...
            int fallback = 0;
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                fallback = ThemeUtils.resolveColor(context, androidx.appcompat.R.attr.colorControlHighlight);
            }
